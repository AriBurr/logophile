...
export const addBookshelf = (bookshelf) => {
  return dispatch => {
    axios.post('/api/bookshelves', { bookshelf }, setHeaders() )
      ...
      .catch( err => dispatch(setFlash(`Could not create ${bookshelf.name}, please try again!`, 'red')));
  }
}
...
export const fetchBookshelves = () => {
  return dispatch => {
    axios.get('/api/bookshelves/', setHeaders())
      ...
      .catch( err => setFlash('Could not retrieve bookshelves, please try again!', 'red'));
  }
}
...
export const editBookshelf = (id, bookshelf) => {
  return (dispatch) => {
    axios.put(`/api/bookshelves/${id}`, { bookshelf }, setHeaders() )
      ...
      .catch( err => setFlash('Could not edit bookshelf, please try again!', 'red'));
  }
}
...
export const deleteBookshelf = (shelf) => {
  return (dispatch) => {
    axios.delete(`/api/bookshelves/${shelf.id}`, setHeaders() )
      ...
      .catch( err => setFlash('Could not delete bookshelf, please try again!', 'red'));
  }
}
